function [db, dbP, dbAccount] = hwForgottenPass(edtUser, edtPass, edtHashPassIndex, etdHashUserPassIndex, ...
...
if isempty(edtPass.String)
    warndlg('Please choose a new password.','! Warning !');
    return;
end
